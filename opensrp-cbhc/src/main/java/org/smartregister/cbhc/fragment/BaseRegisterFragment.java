    ...
    public String filterSelect(String filter) {
        ...
        if(filter.equals("pregnant")){
            columns = new String[]{
                    ...
                    tableName + "." + "Patient_Identifier",
                    tableName + "." + DBConstants.KEY.PHONE_NUMBER,
                    "(select ec_woman.PregnancyStatus from ec_woman where (ec_woman.PregnancyStatus = 'Antenatal Period' or ec_woman.PregnancyStatus like '%প্রসব পূর্ব%') and ec_household.id=ec_woman.relational_id) as pregnant_status"
                    };
