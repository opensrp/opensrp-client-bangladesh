...
public class HouseholdSmartRegisterActivityTest extends BaseUnitTest {
    ...
    HouseholdSmartRegisterActivity activity;
    ActivityController<HouseholdSmartRegisterActivity> controller;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        Intent intent = new Intent(RuntimeEnvironment.application,HouseholdSmartRegisterActivity.class);
        controller = Robolectric.buildActivity(HouseholdSmartRegisterActivity.class,intent);
