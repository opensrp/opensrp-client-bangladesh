...
// */
//@Config(shadows = {SecuredActivityShadow.class, CloudantDataHandlerShadow.class, UniqueIDRepositoryShadow.class, LocationPickerViewShadow.class, MyShadowAsyncTask.class, CommonRepositoryShadow.class, SecuredFragmentShadow.class, ShadowContextForRegistryActivity.class})
//public class HouseholdSmartRegisterActivityTest extends BaseUnitTest {
//
...
//
//    HouseholdSmartRegisterActivityMock activity;
//    private Map<String, String> details;
//    ActivityController<HouseholdSmartRegisterActivityMock> controller;
//
//    @Mock
...
//
//
//        Intent intent = new Intent(RuntimeEnvironment.application,HouseholdSmartRegisterActivityMock.class);
//        controller = Robolectric.buildActivity(HouseholdSmartRegisterActivityMock.class,intent);
...
//
//    @Test
//    public void startRegistrationShouldLaunchJsonForm() {
...
//
//    @Test
//    public void clickProfileShouldLaunchDetails() {
//        final ListView list = (ListView) activity.findViewById(R.id.list);
//        ListAdapter  adapter = tryGetAdapter(list);
